...
export class AuthserviceService {
  ...
  checkUserToken():Observable<boolean>{
    ...
    return this.http.post('https://lets-todo-ypn7.onrender.com/api/home',{},{headers}).pipe(
      map(()=>{
        return true;
      }),
      catchError((err)=>{
  ...
  signUpUser(userData:any):Observable<boolean>{
    ...
    return this.http.post('https://lets-todo-ypn7.onrender.com/api/signup',data).pipe(
      map((res:any)=>{
  ...
  signInUser(userData:any):Observable<boolean>{
    ...
    return this.http.post('https://lets-todo-ypn7.onrender.com/api/signin',data).pipe(
      map((res:any)=>{
